...
const source = join(root, "preview-build");
...
// Production now publishes the exact preview approved by the site owner.
// Stop here so legacy generators cannot rewrite its HTML, CSS, or assets.
writeFileSync(join(out, ".nojekyll"), "");
console.log("Approved preview-build copied to the production Pages artifact.");
process.exit(0);
