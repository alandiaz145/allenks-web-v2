...
function renderReleases() {
  return `<section class="v4-releases" id="lanzamientos" aria-labelledby="v4-releases-title"><div class="v4-releases-shell"><div class="v4-releases-head"><h2 id="v4-releases-title">LANZAMIENTOS</h2></div><div class="v4-video-block"><div class="v4-video-frame"><iframe title="BUST IT — ALLEN KS" data-src="https://www.youtube.com/embed/ki1cUmKv_5Y?rel=0&modestbranding=1" width="100%" height="100%" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen="" loading="lazy"></iframe></div></div><a class="v4-catalog-link" href="/musica/">VER TODAS LAS CANCIONES <span aria-hidden="true">→</span></a></div></section>`;
}
