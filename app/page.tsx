    ...
    <main id="top">
      ...
      <section className="home-hero section-dark">
        <div className="hero-copy">
          <div className="section-index"><span>01 DJ · PRODUCTOR · PROMOTOR</span></div>
        ...
        <figure className="hero-photo-card">
          ...
          <figcaption>DJ SET EN VIVO · OTRA NOCHE FT. DANCING BUDHAS 2026</figcaption>
        </figure>
      </section>
      ...
      <section id="lanzamientos" className="releases-section section-paper">
        <div className="section-head">
          <div>
            <div className="section-index"><span>02 LANZAMIENTOS</span></div>
            <h2>LANZAMIENTOS</h2>
          </div>
        ...
        <div className="release-grid">
          <article className="release-card">
            ...
            <LazyEmbed className="square-embed" src={site.latestSoundCloudEmbed} title="GETTING STARTED de ALLEN KS en SoundCloud" />
          </article>
          <article className="release-card release-card-dark">
            ...
            <LazyEmbed className="square-embed" src={site.upcomingSoundCloudEmbed} title="BASS SO HEAVY de ALLEN KS en SoundCloud" />
      ...
      <section id="en-vivo" className="live-section section-dark">
        <div className="section-head section-head-light">
          <div>
            <div className="section-index"><span>03 ESCENARIOS & FECHAS</span></div>
            <h2>EN VIVO</h2>
        ...
        <div className="live-grid">
          ...
          <aside className="agenda">
            ...
            <a className="button button-red full" href={site.bookingWhatsapp} target="_blank" rel="noreferrer">BOOKING / CONTRATACIONES ↗</a>
          </aside>
        </div>
      </section>
      ...
      <section className="projects-home section-paper">
        <div className="section-head">
          <div>
            <div className="section-index"><span>04 UNIVERSO ALLEN KS</span></div>
            <h2>PROYECTOS</h2>
          </div>
        ...
        <div className="project-grid">
          <a className="project-card project-card-dark" href="/proyectos#spartans">
            <span>01 SELLO INDEPENDIENTE</span>
            <h3>SPARTANS<br />LABEL</h3>
            <p>Dubstep y Bass Music latinoamericano: artistas, lanzamientos y demos.</p>
            <b>CONOCER SPARTANS → ↗</b>
          </a>
          <a className="project-card project-card-red" href="/proyectos#otra-noche">
            <span>02 FIESTAS & COMUNIDAD</span>
            <h3>OTRA<br />NOCHE</h3>
            <p>Fiestas, DJs, sets y cruces alrededor de la cultura bass.</p>
            <b>CONOCER OTRA NOCHE → ↗</b>
          </a>
        </div>
      </section>
      ...
      <section className="contact-cta section-dark">
        ...
        <div><p>BOOKINGS · COLABS · PRODUCCIÓN</p><h2>¿TENÉS UNA IDEA?</h2><span>Fechas, colaboraciones, producción y propuestas.</span></div>
